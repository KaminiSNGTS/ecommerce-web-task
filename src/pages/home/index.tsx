...
const HomePage: React.FC = () => {
  ...
  // Fixing the onChange event type for SelectChangeEvent
  const handleCategoryChange = (event: SelectChangeEvent<string>) => {
    ...
    if (category === 'All') {
      ...
      setFilteredProducts(filtered); // Filter products based on category
    }
  };
    ...
    <div>
      <FormControl fullWidth sx={{ marginBottom: '20px', width:{xs:'100%', md:'50%', lg:'30%', pt:4} }}>
        ...
        >
          ...
          <MenuItem value="men's clothing">men's clothing</MenuItem> {/* Replace with actual categories */}
